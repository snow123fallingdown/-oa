...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "dvadmin.utils.jwt_auth.CustomJWTAuthentication",  # 自定义JWT认证-不检查is_active
        "rest_framework.authentication.SessionAuthentication",
    ),
    "DEFAULT_PERMISSION_CLASSES": [
        "dvadmin.utils.permission.IsAuthenticatedIgnoreInactive",  # 自定义权限-不检查is_active
    ],
